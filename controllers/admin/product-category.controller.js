...
module.exports.createPOST = async (req, res) => {
    if(res.locals.roles.permission.includes('product-category_create')){
...
module.exports.changeStatus = async (req, res) => {
    if(res.locals.roles.permission.includes('product-category_edit')){
        try {
...
module.exports.delete = async (req, res) => {
    if(res.locals.roles.permission.includes('product-category_delete')){
        try{
            const id = req.params.id;
            await ProductCategory.updateOne({_id: id}, {
                deleted: true,
